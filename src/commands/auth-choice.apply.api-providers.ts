...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "cohere-api-key": {
    ...
    expectedProviders: ["cohere"],
    envLabel: "COHERE_API_KEY",
    promptMessage: "Enter Cohere API key",
    setCredential: setCohereApiKey,
    defaultModel: COHERE_DEFAULT_MODEL_REF,
    applyDefaultConfig: applyCohereConfig,
    applyProviderConfig: applyCohereProviderConfig,
    noteDefault: COHERE_DEFAULT_MODEL_REF,
  },
  "venice-api-key": {
    provider: "venice",
