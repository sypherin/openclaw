...
describe("checkInboundAccessControl", () => {
  ...
  it("suppresses pairing replies for history-sync (append) messages", async () => {
    const connectedAtMs = 1_000_000;
    // Even a very recent message should be suppressed when it comes from a history sync batch.
    const messageTimestampMs = connectedAtMs - 1_000;
